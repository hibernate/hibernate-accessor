 ...
 * the generated class holds {@link AsmBulkAccessor} fields and
 ...
 */
final class AsmMultiValueClassGenerator implements Opcodes {

	private static final String READER_INTERNAL = Type.getInternalName( MultiValueReader.class );
	private static final String WRITER_INTERNAL = Type.getInternalName( MultiValueWriter.class );
	private static final String BULK_ACCESSOR_INTERNAL = Type.getInternalName( AsmBulkAccessor.class );
	private static final String BULK_ACCESSOR_DESC = Type.getDescriptor( AsmBulkAccessor.class );
