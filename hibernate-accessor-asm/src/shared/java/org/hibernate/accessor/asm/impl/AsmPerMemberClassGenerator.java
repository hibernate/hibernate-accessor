...
/**
 * Generates one dedicated class per member for the {@link org.hibernate.accessor.asm.AsmGenerationStrategy#PER_MEMBER PER_MEMBER}
 ...
 */
final class AsmPerMemberClassGenerator implements Opcodes {

	private static final String READER_INTERNAL = Type.getInternalName( ValueReader.class );
	private static final String WRITER_INTERNAL = Type.getInternalName( ValueWriter.class );

	private AsmPerMemberClassGenerator() {
	}
